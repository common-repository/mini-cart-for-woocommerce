...
class whmcm_lightmenusettings
{
    ...
    public function whmc__menu_setting()
    {
        ...
        register_setting("whmc_menu", "whmc_menu", array(
        $this,
        'whmc_menu_sanitize'
        ));
  ...
  /**
   ...
   public function whmc_meiconbeha()
    ...
    public function wmhc_menu_cart_style()
    {
        ...
        $icon_1 = MCFWC_LIGHT_URL . 'assets/admin/img/style-one.jpg';
        $icon_2 = MCFWC_LIGHT_URL . 'assets/admin/img/style-two.jpg';
        $icon_3 = MCFWC_LIGHT_URL . 'assets/admin/img/style-three.jpg';
        $icon_0 = MCFWC_LIGHT_URL . 'assets/admin/img/image.PNG';
...
?>
    <ul class="iconstylmc"><li>     
        ...
        echo esc_attr($fcp_menu_style) == 'fcp_menu_0' ? 'checked' : ''; ?>> <label for="menu-0" class="iconstylmcsdd" id="<?php echo $fcp_icon_option ?>"><div class="cart_menu_li menu-link"><div id="menuiconwraps" class="adlkjfhdjndhf icons02">
        <span class="<?php echo $fcp_icon_option ?>"  id="menuiconid1"></span><span class="cart_count_headers">5</span></div>
</div></label> </li><li>
...
<span class="<?php echo $fcp_icon_option ?>"  id="menuiconid2"></span><span class="cart_count_headers">5</span><span class="cart_count_totals qasdsds"><?php echo wc_price('80') ?></span></div></div></label> </li><li>
...
<span class="<?php echo $fcp_icon_option ?>" id="menuiconid3"></span><span class="cart_count_headers">5</span><span class="cart_count_totals icon_minus"><?php echo wc_price('80') ?></span></div></div></label></li><li>
...
<div class="cart_menu_li menu-link"><div id="" class="adlkjfhdjndhf"><span class="<?php echo $fcp_icon_option ?>"  id="menuiconid4"></span><span class="cart_count_totals"><?php echo wc_price('80') ?></span></div></div></label></li></ul>
   ...
   public function wmhc_menuamntbehav()
    ...
    public function fcp_menu_cart_size()
    {
        ...
        printf('<input type="range" name="whmc_menu[fcp_menu_cart_size]" value="%s" min="10" max="50" id="fcp_menu_cart_size" oninput="mcsiz.value = this.value"><output id="mcsiz">%s</output> <span class="dashicons dashicons-image-rotate" id="fcp_menu_cart_sizeundo"></span>', $valus,$valus);
    ...
    public function fcp_menu_txt_size()
    {
        ...
        printf('<input type="range" name="whmc_menu[fcp_menu_txt_size]" value="%s" min="10" max="50" id="fcp_menu_txt_size" oninput="mtsiz.value = this.value"><output id="mtsiz">%s</output> <span class="dashicons dashicons-image-rotate" id="fcp_menu_txt_sizeundo"></span></li>', $valus,$valus);
    ...
    public function wmhc_header_text_color()
    {
        ...
        printf('<input type="text" name="whmc_menu[wmhc_header_text_color]" value="%s"  class="header_text_bubble" id="wmhc_header_text_color">', $options_rang_t_value);
    ...
    public function wmhch_bubbles_txt()
    {
        ...
        printf('<input type="text" name="whmc_menu[wmhch_bubbles_txt]" value="%s"  class="header_bubble" id="wmhch_bubbles_txt">', $wmhch_bubbles_txt);
    ...
    public function wmhc_header_bubble_color()
    {
        ...
        printf('<input type="text" name="whmc_menu[wmhc_header_bubble_color]" value="%s"  class="header_bubble" id="wmhc_header_bubble_color">', $options_rang_value);
    ...
    public function wmhch_bubbles_color()
    {
        ...
        printf('<input type="text" name="whmc_menu[wmhch_bubbles_color]" value="%s"  class="header_bubble" id="wmhch_bubbles_color">', $wmhch_bubbles_color);
    ...
    public function wmhc_hide_text_color()
    {
        ...
        printf('<input type="checkbox" name="whmc_menu[wmhc_hide_text_color]" class="whmc_apple-switch"  value="wmhc_hide_text_color" %s id="wmhc_hide_text_color"><p class="whmc_description">'.__('Click on for remove amount ','mini-cart-for-woocommerce').'</p>', (isset($options['wmhc_hide_text_color']) && $options['wmhc_hide_text_color'] === 'wmhc_hide_text_color') ? 'checked' : '');

    }

    public function whmc_menu_sanitize($input)
    {
        ...
        if (isset($input['fcp_menu_txt_size']))
        {
            $sanitary_values['fcp_menu_txt_size'] = $input['fcp_menu_txt_size'];
        }
        ...
        if (isset($input['whmc_menu_choose']))
        {
            $sanitary_values['whmc_menu_choose'] = $input['whmc_menu_choose'];
        }
        ...
        if (isset($input['fcp_menu_cart_size']))
        {
            $sanitary_values['fcp_menu_cart_size'] = $input['fcp_menu_cart_size'];
        }
        if (isset($input['whmc_meiconbeha']))
        {
            $sanitary_values['whmc_meiconbeha'] = $input['whmc_meiconbeha'];
        }
