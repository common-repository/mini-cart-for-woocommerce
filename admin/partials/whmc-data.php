<?php
    ...
    $wmhcside_toppart_txt = isset($sidepanels["wmhcside_toppart_txt"])
        ? $sidepanels["wmhcside_toppart_txt"]
        : "#505050";
    $wmhcside_toppart_txtcu = isset($sidepanels["wmhcside_toppart_txtcu"])
        ? $sidepanels["wmhcside_toppart_txtcu"]
        : esc_html__("Cart items", "mini-cart-for-woocommerce");
    ...
    $wmhupimage = isset($sidepanels["wmhupimage"]) ? $sidepanels["wmhupimage"] : MCFWC_LIGHT_URL.'assets/admin/img/mini-cart-logo-min.png';
    ...
    $notifications_title_color = isset($notifications["notification_title_color"])
        ? $notifications["notification_title_color"]
        : "#4c4c4c";

    $notifications_bg_color = isset($notifications["notification_background_color"])
        ? $notifications["notification_background_color"]
        : "#68d619";
    $notification_boxshadow = isset($notifications["notification_boxshadow"])
        ? $notifications["notification_boxshadow"]
        : "#fff";

    $progress_color = isset($notifications["notification_progress_bar_color"])
        ? $notifications["notification_progress_bar_color"]
        : "#dd0f0f";

    $notification_round_bar = isset($notifications["notification_round_bar"])
        ? $notifications["notification_round_bar"]
        : "checked";
    $notification_enabes_whmc = isset($notifications["notification_enabes_whmc"])
        ? $notifications["notification_enabes_whmc"]
        : "no";

    $suceess_icon_color = isset($notifications["suceess_icon_color"])
        ? $notifications["suceess_icon_color"]
        : "#fff";

    $notifications_rang_value = isset(
        $notifications["wmhc_notification_added_text"]
    )
        ? $notifications["wmhc_notification_added_text"]
        : "added successfully";
    $notification_position = isset($notifications["notification_position"])
