 ...
 */
 class WHMC_LIGHT_H {
	...
	private function load_dependencies() {
		...
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'inc/class-whmc-light-i18n.php';
	 ...
	 *
	 * Uses the mini-cart-for-woocommerce_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    2.0.4
	 * @access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new WHMC_i18n_light();
